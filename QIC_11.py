...
########################################
p.newSlide()
p.title("QIC.11: Part II: Building a quantum computer with atoms and lasers")
p.makeGrid(4,4)
p.gridText(0,0,r"""
...
p.gridImage(0,2,"./QIC_Figures/QIC1_superconducting_3.jpg", height = 100, textBelow="Google's Sycamore processor. $+$IBM", fontSize = 0.5)

p.gridImage(1,2,"./QIC_Figures/QIC1_ions_2.png", height = 100, textBelow="Honeywell and IonQ", fontSize = 0.5)

p.gridImage(1,3,"./QIC_Figures/QIC1_Rydberg_array.png", height = 100, textBelow="Barredo et al, Nature  **561**, 79 (2018). Pasqal, Quera", fontSize = 0.5)
...
* Qubits: Atoms (Rb, Cs, Sr) DVC1 Initialisatio [QIC.12-14]
* Gates (lasers): DVC2.1 Single-qubit gates [QIC.15] and DVC2.2 Two-qubit gates [QIC.16-18]
* DVC3 Read-out (lasers) [QIC.14-15]
* Low decoherence (select particular states) [QIC.11, 13 and 15]
* Scalability (optical tweezer arrays) [QIC.12-14]
