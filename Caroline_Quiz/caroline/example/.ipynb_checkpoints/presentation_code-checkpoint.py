...
p = Presentation(logo="./caroline/images/institution_logo_placeholder.jpg",
           leftHanded=False,
           drawingHelp="dots",
           drawingHelpIntensity=0.06#,
           #roundTableServer = "https://roundtable.researchx3d.com",
           #presentationServer = "http://localhost:8000/first_presentation_audience.html",
           #authentificationToken = "osagASfew8t31qNqfHQ3Gq"
          )
# localhost:5000
...
""")
p.rightImage("./presentation_files/4.png",
            textBelow="**Figure**: Icelandic Spar Crystal. ")
...
""")
p.rightText("Undo works per slide per annotation, while if you want to edit textual annotation, double click on it while in pointer mode.")
...
p.newQuiz(
    ...
    answersImage=["./presentation_files/em1.png", "./presentation_files/em2.png", "./presentation_files/em3.png", 
                  "./presentation_files/em6.png", "./presentation_files/em5.png", "./presentation_files/em4.png"]      
)
...
p.newQuiz(
    ...
    answersImage=["./mirror_a4.png", "./mirror_a2.png", "./mirror_a1.png", "./mirror_a3.png"]      
)
...
p.leftText("We can embed not only 3D model from ResearchX3D, but also a story that consists of multiple segments, each with textual and 3D annotation, and even supporting figures.")
p.rightIFrame("https://www.researchx3d.com/en/?o=12&s=12&e", height=800)

p.newSlide()
p.title("Embeding Skechfab 3D object")
p.leftText("""We can also use other sources of 3D models, like  [Sketchfab](https://sketchfab.com/), using their **embed** URI.

:point_up: You can still use annotations to draw and write over the 3D model if you wish!
""")
p.rightIFrame("https://sketchfab.com/models/770e7a94c2884e9c992dce238cb24157/embed?camera=0&ui_animations=0&ui_inspector=0&ui_help=0&ui_settings=0&ui_vr=0&ui_fullscreen=0&ui_annotations=1", height=650)
...
p.spanCenterIFrame("https://youtu.be/41Jc75tQcB0?start=1228&end=1300",height=915)  # both formats work; keep height large (this is max height, it will shrink for smaller screens
...
p.leftText(r"""
[Caroline Herschel](https://en.wikipedia.org/wiki/Caroline_Herschel) (1750-1848) was pioneering astronomer and scientists. She had indenpendant scientific career as a creator of New General Catalogue and discoverer of several comets, in addition to her work with her brother William Hereschel early in her career. She was the first woman to receive a salary as a scientists, the first woman to hold a government position in England, the first woman to publish scientific findings in the Philosophical Transactions of the Royal Society. 
...
""", fontSize=0.8)
p.rightImage("./presentation_files/Caroline_Herschel.jpeg", textBelow="Caroline Herschel  at 78, one year after winning the Gold Medal of the Royal Astronomical Society in 1828. She also received Prussian Gold Medal for Science in 1846.", fontSize=0.8, height=400)
...
:-- | :-- | :--
`span`, `spanCenter`, `left`, `right`, `grid`  | + `Text`, `MP4`, `Image`, `IFrame`  | = `spanText(...)` for example
...
p.save("./first_presentation.html")
