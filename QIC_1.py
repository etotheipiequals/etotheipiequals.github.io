...
** QIC.1 Qubits and the quantum advantage**
...
* Slides (without annotations) .pdf files
...
""")
p.rightImage("./Figures/Ultra_Course_Materials.png", height = 400)
...
p.newSlide()
p.title("Interactive figures: https://etotheipiequals.github.io")

p.spanCenterIFrame("https://etotheipiequals.github.io", height=1200)
...
Qubits and the quantum advantage """, fontSize = 1.0)
