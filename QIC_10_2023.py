...
########################################
p.newSlide()
p.title("QIC.10: Quantum circuit model of decoherence")
p.makeGrid(4,4)
p.gridText(0,0,r"""
...
p.spanCenterIFrame("./QIC_Videos/QIC_10_p3.mp4", height= 1400)
...
p.gridImage(1,1,"./QIC_Figures/QIC10_wheeler_1.jpg", height = 300)
...
p.spanCenterIFrame("./QIC_Videos/QIC_10_p4.mp4", height= 1400)
